...
<head>
    ...
    <title>David Guben | Portfolio</title>
    <!-- Bootstrap Core CSS -->
                    ...
                    <form name="sentMessage" id="contactForm" novalidate>
                        ...
                        <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                ...
                                <input type="tel" class="form-control" placeholder="Phone Number" id="phone" required data-validation-required-message="Phone Number (Optional)">
                                <p class="help-block text-danger"></p>
                            </div>
                        </div>
                        <div class="row control-group">
            ...
            <div class="row intro-content">
                <div class="col-md-4 contact-details social">
                  <ul class="list-inline">
                      ...
                      <li><a href="https://twitter.com/Dav_js" target="_blank"><i class="fa fa-twitter fa-fw fa-2x"></i></a>
                      </li>
